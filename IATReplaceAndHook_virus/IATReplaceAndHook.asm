...
;================================
push ebx
push 0xBEDAABDE ; caption, sẽ sử dụng hàm để thay thế địa chỉ đại diện này thành địa chỉ tính được
push 0xEDDCEFCD ; text, sẽ sử dụng hàm để thay thế địa chỉ đại diện này thành địa chỉ tính được
push ebx
call eax
mov ecx, 7
pop_loop:
...
loop pop_loop
pop ebp
mov eax, 0xEEDFADEA; OEP, sẽ sử dụng hàm để thay thế địa chỉ đại diện này thành địa chỉ tính được
jmp eax